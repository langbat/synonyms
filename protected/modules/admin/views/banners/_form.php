...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row-form clearfix">
		...
		<div class="span3">
            <?php echo $form->dropDownList($model,'position', array( 1 =>'Top', 2 =>'Bottom' ) ); ?>
		...
		<div class="span3">
            <?php echo $form->dropDownList($model,'type', array(  1 =>'Image', 2 =>'Flash', 3 =>'HTML code' ), array('empty' => Yii::t('global', '--- Please choose ---'))); ?>
