...
class FeedbackType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'userFeedbacks' => array(self::HAS_MANY, 'UserFeedback', 'id_feedback_type'),
		);
	}
    ...
    public function getType($type){
        $criteria = new CDbCriteria();
        $criteria->condition = 'description LIKE "%'.$type.'%"';
        $id_searchType = self::model()->find($criteria);
        return $id_searchType['id'];
    }
}